...
// Legacy package catalog (logo design, social media, flyers, website
// packages, etc.). Intentionally not linked from nav/footer/homepage —
// existing customers with a direct link can still browse and check out.
export const metadata: Metadata = {
  title: 'All Packages & Pricing',
  description:
    'Websites, logos, social media, flyers, and more. Browse Maxora packages with clear pricing and order online.',
    ...
    <div className="mx-auto max-w-6xl px-4 pt-32 pb-24 sm:px-6">
      <div>
        ...
        <h1 className="font-heading text-4xl font-semibold tracking-tight sm:text-5xl">
          Pick a package. <span className="text-gradient">Order in minutes.</span>
        </h1>
